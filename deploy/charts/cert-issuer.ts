    ...
    new externalSecrets.ExternalSecret(this, "certificate-issuer-secret", {
      ...
      spec: {
        ...
        secretStoreRef: {
          ...
          kind: externalSecrets.ExternalSecretSpecSecretStoreRefKind
            .SECRET_STORE,
        },
        target: {
          name: "certificate-issuer-secret",
          creationPolicy:
            externalSecrets.ExternalSecretSpecTargetCreationPolicy.OWNER,
        },
        dataFrom: [
          {
            extract: {
              ...
              conversionStrategy:
                externalSecrets
                  .ExternalSecretSpecDataFromExtractConversionStrategy
                  .DEFAULT,
              decodingStrategy:
                externalSecrets
                  .ExternalSecretSpecDataFromExtractDecodingStrategy.NONE,
              metadataPolicy:
                externalSecrets
                  .ExternalSecretSpecDataFromExtractMetadataPolicy.NONE,
            },
          },
        ],
      },
