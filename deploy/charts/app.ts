...
function createIngressAnnotations(isBackend: boolean): Record<string, string> {
...
export class App extends Chart {
  constructor(scope: Construct, id: string, props: AppProps) {
    ...
    if (!isBackend) {
      new k8s.KubeConfigMap(this, "security-headers", {
        metadata: {
    ...
    new k8s.KubeIngress(this, "ingress", {
      metadata: {
        name: props.name,
        annotations: createIngressAnnotations(isBackend),
      },
      spec: {
