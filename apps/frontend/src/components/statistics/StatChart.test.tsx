...
describe('StatChart', () => {
  it('renders a heading, the chart by default and a graph/table switch', () => {
    ...
    // Chart view by default: chart image shown, no data table yet
    const image = screen.getByRole('img');
    expect(image).toHaveAttribute('aria-label', expect.stringContaining('répartition'));
    expect(screen.queryByRole('columnheader', { name: 'Raison' })).not.toBeInTheDocument();
  });
