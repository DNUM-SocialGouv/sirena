...
const processEnv = {
  ...
  HEALTHCHECK: process.env.HEALTHCHECK,
  HEALTHCHECK_PORT: process.env.HEALTHCHECK_PORT,
  HEALTHCHECK_EVENT_LOOP_THRESHOLD: process.env.HEALTHCHECK_EVENT_LOOP_THRESHOLD,
  HEALTHCHECK_MAX_CONNECTIONS_THRESHOLD: process.env.HEALTHCHECK_MAX_CONNECTIONS_THRESHOLD,
};
