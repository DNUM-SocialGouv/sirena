...
export type SirenaMisEnCauseData = SirenaRppsMisEnCauseData | SirenaFinessMisEnCauseData;
export type { SirenaFaitData, SirenaFinessMisEnCauseData, SirenaLieuDeSurvenueData, SirenaRppsMisEnCauseData };
