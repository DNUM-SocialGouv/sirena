...
-- Missing items for AutoriteTypeEnum
...
-- Missing items for CiviliteEnum
...
-- Missing items for ConsequenceEnum
...
-- Missing items for DemarchesEngageesEnum
...
-- Missing items for EntiteTypeEnum
...
-- Missing items for LienVictimeEnum
...
-- Missing items for LieuTypeEnum
...
-- Missing items for MaltraitanceTypeEnum
...
-- Missing items for MisEnCauseTypeEnum
...
-- Items to update for MisEnCauseTypeEnum
UPDATE "public"."MisEnCauseTypeEnum" SET "label" = 'Un établissement ou un service' WHERE "id" = 'ETABLISSEMENT';


-- Missing items for MotifDeclaratifEnum
...
-- Missing items for ReceptionTypeEnum
...
-- Missing items for RequeteEtapeStatutEnum
...
-- Missing items for TransportTypeEnum
...
-- Missing items for RequeteClotureReasonEnum
...
-- Missing items for RequetePrioriteEnum
...
-- Missing items for MisEnCauseTypePrecisionEnum
